...
// The original four-domain document Q&A, kept at /general while the app
// becomes the IPO analyser (the home page)
export default function GeneralQA() {
  ...
  return (
    <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-6 px-4 py-8 sm:px-6">
      <header className="flex flex-col gap-1">
        ...
        <h1 className="text-2xl font-semibold tracking-tight">General document Q&amp;A</h1>
